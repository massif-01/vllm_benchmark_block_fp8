...
def get_weight_shapes(tp_size):
    # NOTE: Weight shapes for Qwen3-30B-A3B-Instruct-2507-Int8-W8A16 (Qwen3Moe model)
    ...
    #         intermediate_size=6144 (shared expert, if applicable)
    # Model: Qwen/Qwen3-30B-A3B-Instruct-2507-Int8-W8A16
    # Quantization: INT8 W8A16 (weight INT8, activation BF16/FP16)
...
if __name__ == "__main__":
    parser = FlexibleArgumentParser(
        description="""
Tune triton w8a8 block int8 kernel for Qwen3-30B-A3B-Instruct-2507-Int8-W8A16:
    python3 benchmark_w8a8_block_fp8_qwen3_30b.py --tp-size 1 --input-type int8
